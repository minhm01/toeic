  ...
  <div class="panel panel-default">
    ...
    <div class="row">      
        ...
        <div class="col-sm-4">Số câu hỏi: {{$exam->de}} dễ | {{$exam->trungbinh}} trung bình | {{$exam->kho}} khó<br>
          ...
          <button type="submit" name="edit_Exam" class="btn btn-info">Cập nhật danh sách</button>
        </div>      
    </div>
    ...
    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar">
      <table class="table table-striped b-t b-light">
        ...
        <?php if($qt->dokho=='dễ') {?>
          <tr>
            <td><input type="checkbox" name="qt[]" value='{{$qt->id_cauhoi}}'></td>
            <td>{{$qt->id_cauhoi}}</td>
    ...
    </div><header class="panel-heading">câu hỏi trung bình {{$exam->trungbinh}} câu</header>
    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar">
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
    ...
    </div><header class="panel-heading">câu hỏi khó {{$exam->kho}} câu</header>
    <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar">
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
